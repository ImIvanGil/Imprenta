...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <form method="post" enctype="multipart/form-data" action="registro_req.php" name="registro" onSubmit="return validar()">
							...
							<table align="center" width="550px" border="0px">
								...
								<tr align="center"><td>
                                  ...
                                  <fieldset>								  
                                    ...
                                    <tr>
                                    <td align="right"><span>*</span>Proveedor Recomendado: </td>
                                    ...
                                    <tr>
                                    <td align="right" valign="top">Prop&oacute;sito de la compra: </td>
