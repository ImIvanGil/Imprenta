    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <form method="get" action="ordenes_compra.php" name="busqueda" id="busqueda" onSubmit="return validarBusqueda()"> 
            ...
            <tbody>
				...
				<?php 
					...
					if (isset($_GET['parametro'])) {
						  ...
						  $cons ="SELECT * FROM `orden_compra` WHERE `id_orden`= '$buscar' OR `id_proveedor` in (SELECT `id_proveedor` FROM `proveedor` WHERE `nombre` like '%$buscar%') ORDER BY id_orden DESC;";
						  $lista_orden = $db->consulta($cons);
						  
						  $mensaje = "Resultados de la b&uacute;squeda que contienen la palabra clave <b>$buscar</b>";
					  }else{
						  $lista_orden = $db->consulta("SELECT * FROM `orden_compra` ORDER BY id_orden DESC LIMIT 20;");
                    ...
                    while ($rowf = $db->fetch_array($lista_orden))
                        {
							$clave = $rowf['id_orden'];
							$fecha = $rowf['fecha'];
							...
							while ($row3 = $db->fetch_array($consulta_sta)){
							 ...
							 <td class=\"listado\"><a class=\"icono\" title=\"Ver Orden\" href=\"ficha_orden.php?numero=".$clave."\"><img src=\"../images/iconos/onebit_39.png\" width=\"24px\" align=\"center\"></a></td>";
							 if($id_status==1){
								 echo "<td class=\"listado\"><a class=\"icono\" title=\"Editar Orden\" href=\"editar_orden.php?numero=".$clave."\"><img src=\"../images/iconos/onebit_20.png\" width=\"24px\" align=\"center\"></a></td>
							 <td class=\"listado\"><a class=\"icono\" title=\"Borrar Orden\" href=JavaScript:confirma(\"http://localhost/imprenta/compras/borrar_orden.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>
							 </tr>";
							 }else{
								 if($id_status==2){
									 echo "<td class=\"listado\">Operacion <br>No Permitida</td>
							 		<td class=\"listado\"><a class=\"icono\" title=\"Cancelar Orden\"  href=JavaScript:confirma(\"http://localhost/imprenta/ventas/cancelar_orden.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_35.png\" width=\"24px\" align=\"center\"></a></td></tr>";
								 }else{
									 echo "<td class=\"listado\">Operacion <br>No Permitida</td>
        ...
        <div class="col_260 col_last">
        	...
        	<div class="sb_news_box">
            	<ul class="tmo_list col_260">
                     <li><span>&raquo;</span><a href="lista_ordenes.php">Exportar a Excel</a></li>
               </ul>
