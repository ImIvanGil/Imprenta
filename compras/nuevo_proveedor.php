								...
								<tr><td>
                                  ...
                                  <fieldset>								  
								   ...
								   <td> <select id="ciudad" name="ciudad">
								    ...
								    <td> <input class="texto" type="text" id="tel2" name="tel2" size="30" /><br /></td></tr>	    
                                    <tr><td align="right">Tel&eacute;fono 3:</td>
								    <td> <input class="texto" type="text" id="tel3" name="tel3" size="30" /><br /></td></tr>	    
                                    ...
                                    <tr><td align="right"><span>*</span>D&iacute;as de cr&eacute;dito:</td>
								    <td> <input class="texto" type="text" id="dias" name="dias" size="20" /><br /></td></tr>
