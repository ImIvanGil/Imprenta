    ...
    <div id="templatemo_content">
        ...
        <SCRIPT LANGUAGE="JavaScript">
		  <!-- Funcion que valida que se hayan escrito los campos obligatorios-->
            ...
            <form method="get" action="busqueda_insumo.php" name="buscar" onSubmit="return validar()">
                      ...
                      <fieldset>								  
                        ...
                        <tr><td align="right" valign="middle">
                        	<select id="par1" name="par1">
                                ...
                                <option value="id_insumo">Numero</option>
			   ...
			   <?php
                //+++++++++++++++++++++++++++++++SI SELECCIONO BUSCAR ++++++++++++++++++++++++++++++++++++++++
                    if (isset($_GET['buscar'])) {
						...
						if($pars!=""){
							$consulta = $consulta." WHERE ".$pars." ORDER BY id_insumo ASC;";
						}
                            	...
                            	<?php 
									while ($row = $db->fetch_array($lista_res))
										...
										$descripcion = $row['descripcion'];
										 ...
										 <td class=\"listado\"><a class=\"icono\" href=JavaScript:confirma(\"http://localhost/imprenta/borrar_insumo.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>
