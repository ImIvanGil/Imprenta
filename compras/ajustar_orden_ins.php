...
if (isset($_GET['guardar'])) {
	...
	$query = "UPDATE `imprenta`.`detalle_orden` SET `ajuste` = '$cant', `causa_ajuste` = '$causa' WHERE `detalle_orden`.`id_detalle` =$cve_det;";
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <?php
				...
				$cons_ajuste = $db->consulta("SELECT `ajuste` FROM `detalle_orden` WHERE `id_detalle` =$detalle");
				...
				<form method="get" action="ajustar_orden_ins.php" name="regIns" onsubmit="return validarIns()">
