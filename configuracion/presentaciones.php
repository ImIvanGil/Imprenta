...
if (isset($_GET['presentacion'])) {
	$nombre = $_GET['presentacion'];
	//recibi las variables y ahora hare la consulta con el insert
	$consulta = $db->consulta("insert into presentacion(nombre) values('".$nombre."');");  
}
?>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Presentaciones de Insumos</h2>
            <div id="data_form">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					if (document.registro.presentacion.value == "") {
						alert ('Debe escribir el nombre de la presentacion');
            ...
            <form method="get" enctype="multipart/form-data" action="presentaciones.php" name="registro" onSubmit="return validar()">	
							<table align="center" width="550px" border="0px">
								
								<tr align="center"><td>
								  <BR>
                                  <fieldset>								  
								    <legend> <B>Nueva presentaci&oacute;n de insumos</B></legend>
								    <table border="0" align="center">	

								    <tr><td align="right"><span>*</span>Nombre:</td>
								    <td> <input class="texto" type="text" id="presentacion" name="presentacion" size="40" /><br /></td>
                                    <td>&nbsp;</td>
                            ...
                            <fieldset>								  
                              <legend> <B>Detalle</B></legend>
								<?php 
                                    ...
                                    $detalle = $db->consulta("SELECT * FROM `presentacion`");
                                    $existe = $db->num_rows($detalle);
									
                                    if($existe<=0){
                                        echo "<p align=\"center\">No se han agregado presentaciones de insumos al sistema</p>";
									...
									?>
                                        ...
                                        <thead>
                                            <tr align="center">
                                                ...
                                                <th class="header">Presentaci&oacute;n</th>
