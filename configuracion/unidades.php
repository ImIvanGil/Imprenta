...
if (isset($_GET['unidad'])) {
	...
	$consulta = $db->consulta("insert into unidades(unidad) values('".$unidad."');");  
}
?>
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					if (document.registro.unidad.value == "") {
						alert ('Debe escribir el nombre de la unidad de medida');
            ...
            <form method="get" enctype="multipart/form-data" action="unidades.php" name="registro" onSubmit="return validar()">	
							<table align="center" width="550px" border="0px">
								
								<tr align="center"><td>
								  <BR>
                                  <fieldset>								  
								    <legend> <B>Nueva unidad de medida</B></legend>
								    <table border="0" align="center">	

								    <tr><td align="right"><span>*</span>Unidad:</td>
								    <td> <input class="texto" type="text" id="unidad" name="unidad" size="40" /><br /></td>
                                    <td>&nbsp;</td>
                            ...
                            <fieldset>								  
                              <legend> <B>Detalle</B></legend>
								<?php 
                                    ...
                                    $detalle = $db->consulta("SELECT * FROM `unidades`");
                                    $existe = $db->num_rows($detalle);
									
                                    if($existe<=0){
                                        echo "<p align=\"center\">No se han agregado unidades de medida al sistema</p>";
