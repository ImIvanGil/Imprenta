...
if (isset($_GET['color'])) {
	...
	$consulta = $db->consulta("insert into tinta(tinta) values('".$color."');");  
}
?>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					if (document.registro.color.value == "") {
						alert ('Debe escribir el nombre del color de tinta');
            ...
            <form method="get" enctype="multipart/form-data" action="colores.php" name="registro" onSubmit="return validar()">	
							<table align="center" width="550px" border="0px">
								
								<tr align="center"><td>
								  <BR>
                                  <fieldset>								  
								    <legend> <B>Nuevo color de tinta</B></legend>
								    <table border="0" align="center">	

								    <tr><td align="right"><span>*</span>Color:</td>
								    <td> <input class="texto" type="text" id="color" name="color" size="40" /><br /></td>
                                    <td>&nbsp;</td>
                            ...
                            <fieldset>								  
                              <legend> <B>Detalle</B></legend>
								<?php 
                                    ...
                                    $detalle = $db->consulta("SELECT * FROM `tinta`");
                                    $existe = $db->num_rows($detalle);
									
                                    if($existe<=0){
                                        echo "<p align=\"center\">No se han agregado colores de tinta al sistema</p>";
