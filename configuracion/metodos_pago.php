...
if (isset($_GET['metodo'])) {
	...
	$consulta = $db->consulta("insert into metodo_pago(metodo_pago) values('".$metodo."');");  
}
?>
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					if (document.registro.metodo.value == "") {
						alert ('Debe escribir el metodo de pago');
            ...
            <form method="get" enctype="multipart/form-data" action="metodos_pago.php" name="registro" onSubmit="return validar()">	
							<table align="center" width="550px" border="0px">
								
								<tr align="center"><td>
								  <BR>
                                  <fieldset>								  
								    <legend> <B>Nuevo m&eacute;todo de pago</B></legend>
								    <table border="0" align="center">	

								    <tr><td align="right"><span>*</span>Nombre:</td>
								    <td> <input class="texto" type="text" id="metodo" name="metodo" size="40" /><br /></td>
                                    <td>&nbsp;</td>
                            ...
                            <fieldset>								  
                              <legend> <B>Detalle</B></legend>
								<?php 
                                    ...
                                    $detalle = $db->consulta("SELECT * FROM `metodo_pago`");
                                    $existe = $db->num_rows($detalle);
									
                                    if($existe<=0){
                                        echo "<p align=\"center\">No se han agregado metodos de pago al sistema</p>";
									...
									?>
                                        ...
                                        <thead>
                                            <tr align="center">
                                                ...
                                                <th class="header">M&eacute;todo</th>
