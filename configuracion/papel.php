...
if (isset($_GET['papel'])) {
	...
	$consulta = $db->consulta("insert into tipo_papel(tipo) values('".$nombre."');");  
}
?>
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					if (document.registro.papel.value == "") {
						alert ('Debe escribir el nombre del tipo de papel');
            ...
            <form method="get" enctype="multipart/form-data" action="papel.php" name="registro" onSubmit="return validar()">	
							<table align="center" width="550px" border="0px">
								
								<tr align="center"><td>
								  <BR>
                                  <fieldset>								  
								    <legend> <B>Nuevo tipo de papel</B></legend>
								    <table border="0" align="center">	

								    <tr><td align="right"><span>*</span>Nombre:</td>
								    <td> <input class="texto" type="text" id="papel" name="papel" size="40" /><br /></td>
                                    <td>&nbsp;</td>
                            ...
                            <fieldset>								  
                              <legend> <B>Detalle</B></legend>
								<?php 
                                    ...
                                    $detalle = $db->consulta("SELECT * FROM `tipo_papel`");
                                    $existe = $db->num_rows($detalle);
									
                                    if($existe<=0){
                                        echo "<p align=\"center\">No se han agregado tipos de papel al sistema</p>";
