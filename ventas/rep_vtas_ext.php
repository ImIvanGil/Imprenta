...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <a href="<?php echo "rep_vtas_ext_excel.php?inicio=$inicio&fin=$fin";?>">Exportar a MS Excel</a>
        ...
        <div class="sb_box">
            ...
            <a href="<?php echo "rep_vtas_ext_pdf.php?inicio=$inicio&fin=$fin";?>">Exportar Gr&aacute;ficas</a>
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Reporte comparativo de ventas nacionales y en d&oacute;lares</h2>
			...
			<?php
				...
				$lista = $db->consulta("SELECT * FROM `factura` WHERE fecha BETWEEN '$ninicio' AND '$nfin' and `id_status_factura`='2'");
				...
				<?php 
					...
					$porc_mxn = ($glo_tot_mx/$glo_tot_glo)*100;
					$porc_usd = 100-$porc_mxn;
					...
					<tr>
						...
						<td align=\"right\">% de ventas en USD: </td><td>".number_format($porc_usd,2)." %</td>
						<td align=\"right\">% de ventas en MXN: </td><td> ".number_format($porc_mxn,2)."%</td>
					</tr>
					<tr>
						<td align=\"right\">Tipo de Cambio: </td><td>".number_format($tc_usd,2)."</td>
						<td align=\"right\">Dias del periodo: </td><td>".$dias."</td>
						<td align=\"right\">Ventas diarias promedio en MXN: $</td><td> ".number_format($vtas_prom,2)."</td>
					</tr>
					
					<tr>
						<td align=\"left\" colspan=\"6\"><span>*</span>Datos de ventas en base a tipo de cambio al momento de facturar</td>
					</tr>
					</table>";
				 ...
				 */
				 ...
				 // Dataset definition 
				 $DataSet = new pData;
				 $DataSet->AddPoint(array($porc_mxn,$porc_usd),"Serie1");
				 $DataSet->AddPoint(array("% Ventas en MXN","% Ventas en USD"),"Serie2");
				 ...
				 $Test->Render("graficas/ventas_ext.png");
				 echo "<p align=\"center\"><img src=\"graficas/ventas_ext.png\" /></p>";
