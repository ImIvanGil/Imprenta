    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
           ...
           <?php
			...
			echo "No fue posible certificar el comprobante de tipo $tipo n&uacute;mero $clave<br>";
			echo "Este es el mensaje de error: $mensaje <br>contacte a su administrador de sistemas.<br>";
			if($tipo=='factura'){
				echo "<p align=\"right\"><a href=\"facturas.php?\">Volver a la lista de facturas</a></p>";
			}else{
				
				echo "<p align=\"right\"><a href=\"notas_credito.php?\">Volver a la lista de notas de cr&eacute;dito</a></p>";
			}
           ?>
