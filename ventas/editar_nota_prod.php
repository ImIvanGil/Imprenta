...
if (isset($_GET['editar'])) {
	...
	$query = "UPDATE detalle_nota_credito SET id_producto='$cve_prod',unitario='$unitario', cantidad='$cant', id_clase_iva='$tiva' WHERE id_detalle_nota ='$cve_det';";
	echo "la consulta es ".$query."<br>";
	$consulta = $db->consulta($query);
	$link = "Location: ficha_nota.php?numero=$cve_nota";
	header($link);
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Editar Nota de Cr&eacute;dito - Producto</h2>
            <?php
				$db = new MySQL();
				$nota = $_GET['numero'];
				$detalle = $_GET['key'];
				...
				$consulta_reg = $db->consulta("SELECT *  FROM `detalle_nota_credito` WHERE `id_detalle_nota` = '".$detalle."';");
				...
				?>
				<form method="get" action="editar_nota_prod.php" name="regProd" onsubmit="return validarProd()">
                            <input type="hidden" name="numero" id="numero" value="<?php echo $nota;?>">
