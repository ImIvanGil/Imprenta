    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <a href="<?php echo "rep_vtas_cte_excel.php?inicio=$inicio&fin=$fin&id_cte=$id_cliente";?>">Exportar a MS Excel</a>
    	...
    	<div class="col_w565_interior">
			...
			<?php
				...
				while($row_cli = mysql_fetch_array($consulta_cli)){
					$nom_cliente=utf8_decode($row_cli['nombre']);
					$rfc=utf8_decode($row_cli['rfc']);
				}
				$finicio = cambiarFormatoFecha($inicio);
				$ffin = cambiarFormatoFecha($fin);
				echo "<p>Para el cliente <b>$nom_cliente</b> del <b>$finicio</b> al <b>$ffin</b></p>";
