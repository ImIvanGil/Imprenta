...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Registro de Pago de Cliente</h2>
            ...
            <?php 
				...
				if ($operacion =="registrar"){
					...
					//en aplicado, si es 1 esta para asiganr, si es 2 esta asignado a facturas si es 3 esta cancelado
					$aplicado = 1;
					$query = "INSERT INTO `pago_cliente` (`id_cliente`,`fecha`, `id_tipo_pago`, `motivo_nota`, `referencia`, `id_moneda`, `tipo_cambio`, `monto`, `usuario`, `observaciones`, `aplicado`) VALUES ('".$id_cliente."','".$fecha."','".$tipo_pago."','".$motivo_nota."','".$referencia."','".$id_moneda."','".$tipo_cambio."','".$monto."','".$curUser."','".$observaciones."','".$aplicado."');";
					...
					echo "<p align=\"center\" style=\"font-size: 14px;\"><strong>La el pago del cliente ".$nombre_cliente." ha sido registrado exitosamente. Gracias! </strong></p>";
					//echo "<p align=\"right\"><a href=\"asignar_pago.php?numero=$clave\">Continuar</a></p>";
					echo "<p align=\"right\"><a href=\"cobros_clientes.php?\">Continuar</a></p>";
					...
					$query = "UPDATE pago_cliente SET id_cliente='$id_cliente',fecha='$fecha', id_tipo_pago='$tipo_pago', motivo_nota='$motivo_nota', referencia='$referencia', id_moneda='$id_moneda', tipo_cambio='$tipo_cambio', monto='$monto', usuario='$curUser', observaciones='$observaciones' WHERE id_pago ='$numero_original';";
					//echo "La consulta es ". $query."<br>";
					$consulta = $db->consulta($query);
					
					echo "<p align=\"center\" style=\"font-size: 14px;\"><strong>El pago a nombre del cliente ".$nombre_cliente." con la clave ".$numero_original." ha sido actualizado exitosamente. Gracias! </strong></p>";
