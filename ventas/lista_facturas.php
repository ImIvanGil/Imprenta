...
<body>			
			<table>
			<tr><td align="center" colspan="11"><h4>Sistema Cotizador</h4></td></tr>
			<tr><td align="center" colspan="11"><b>Lista de Facturas</b></td></tr>
			...
			<?php 
				...
				$lista_facturas = $db->consulta("SELECT *  FROM `factura`;");
