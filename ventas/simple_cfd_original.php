...
class SimpleCFD {
  ...
  public static function getXML ( array $data )
  {
    ...
    $xsi->appendChild( $dom->createTextNode( "http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv3.xsd" ) );
    $co->appendChild( $xsi );
    ...
    $xmlns = $dom->createAttribute( 'xmlns:cfdi' );
    $xmlns->appendChild( $dom->createTextNode( "http://www.sat.gob.mx/cfd/3" ) );
