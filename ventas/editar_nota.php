...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Editar Nota de Cr&eacute;dito</h2>
            <div id="data_form">
            ...
            <?php
              $db = new MySQL();
              $clave = $_GET['numero'];
			  $factura = $db->consulta("SELECT * FROM `nota_credito` WHERE id_nota='".$clave."'");
              while ($row = $db->fetch_array($factura))
			  {
				  ...
				  $tipo_comp = $row['id_tipo_comprobante'];
            ...
            <form method="post" enctype="multipart/form-data" action="registro_nota.php" name="registro" onSubmit="return validar()">
                            ...
                            <input type="hidden" name="empresa" id="empresa" value="<?php echo $id_empresa;?>">
                            <input type="hidden" name="status" id="status" value="<?php echo $id_status;?>">
                            <input type="hidden" name="tipo_comp" id="tipo_comp" value="<?php echo $tipo_comp;?>">
							...
							<table align="center" width="550px" border="0px">
								...
								<tr align="center"><td>
                                  ...
                                  <fieldset>								  
								    ...
								    <td> <input class="texto" type="text" id="fecha" name="fecha" size="20" value="<?php echo $solo_fecha;?>" /><br /></td></tr>
                                    ...
                                    <tr><td align="right">No. cuenta pago:</td>
								    <td> <input class="texto" type="text" id="cuenta" name="cuenta" size="20" value="<?php echo $cuenta;?>" /><br /></td></tr>
