							...
							<table align="center" width="550px" border="0px">
								...
								<tr align="center"><td>
                                  ...
                                  <fieldset>								  
													...
													while ($row6 = $db->fetch_array($lista_tam))
													{
													  ...
													  $cte = utf8_decode($row6['nombre']);
														 if($id_cliente==$id_cliente1){
																  echo "<option value=\"".$id_cliente1."\"selected>".$cte."</option>";
															}else{
																   echo "<option value=\"".$id_cliente1."\">".$cte."</option>";
															}
                                            ...
                                            <?php 
												$lista_sta = $db->consulta("SELECT * FROM `status_cotizacion`;");
													while ($row6 = $db->fetch_array($lista_sta))
													{
													  ...
													  if($id_sta==$id_status){
															  echo "<option value=\"".$id_sta."\"selected>".$sta."</option>";
														}else{
								    ...
								    <td> <input class="texto" type="text" id="vigencia" name="vigencia" size="6"value="<?php echo $vigencia;?>" />  d&iacute;as<br /></td></tr>
