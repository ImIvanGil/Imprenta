...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					...
					if (document.registro.status.value == "-1") {
						alert ('Debe seleccionar un status para la factura');
            ...
            <form method="post" enctype="multipart/form-data" action="registro_factura.php" name="registro" onSubmit="return validar()">
                            ...
                            <!--Asigno tipo de comprobante de ingresos por defecto -->
                            <input type="hidden" name="tipo_comp" id="tipo_comp" value="1">
                            <!--Ahora voy a enviar la serie 1 de folios en un campo oculto pero esto se puede modificar para poner un select si hay mas series -->
                            <input type="hidden" name="serie" id="serie" value="1">
                            <!--Asigno tipo de iva normal al 16% para la factura -->
                            <!--input type="hidden" name="iva" id="iva" value="1"-->
								...
								<tr align="center"><td>
                                  ...
                                  <fieldset>								  
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                    <td align="right">Orden de compra del cliente: </td>
                                    <td align="left" valign="middle"><input class="texto" type="text" id="oc_cliente" name="oc_cliente" size="20" /><br />
                                   </td>
                                    </tr>
                                    
                                    <tr>
                                    <td align="right">No. de cuenta pago: </td>
                                    <td align="left" valign="middle"><input class="texto" type="text" id="cuenta" name="cuenta" size="20" /><br />
                                   </td>
                                    </tr>
