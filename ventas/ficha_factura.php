            ...
            <table align="center" border="0" width="100%" cellspacing="0" cellpadding="0">
               ...
               <?php 
				...
				?>
                        ...
                        <tr>
                            <td align="center">
                            <form method="POST" action="ficha_factura.php" name="regProd" onsubmit="return validarProd()">
                                                       ...
                                                       echo "<tr><td class=\"listado\" align=\"center\">".$i."</td>
														...
														if($id_status==1){		 
														   echo "<td class=\"listado\" align=\"center\"><a class=\"icono\" href=\"editar_fac_prod.php?numero=$clave&key=$id_detalle\"><img src=\"../images/iconos/onebit_20.png\" width=\"24px\" align=\"center\"></a></td>
																 <td class=\"listado\" align=\"center\"><a class=\"icono\" href=JavaScript:confirma(\"http://localhost/imprenta/ventas/borrar_fac_prod.php?numero=$clave&key=$id_detalle\",\"$id_detalle\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>";
                                ...
                                if($id_status==2){
                                    ...
                                    echo "<a href=\"cfdi_pdf.php?clave=$clave&letras=$letras\"><i>Descargar Representacion Impresa de CFDI</i></a><img src=\"../images/iconos/onebit_39.png\" width=\"24px\" /><br>";
                                        ...
                                        if($id_status==3){
											...
											echo "<a href=\"descarga_cfdi.php?file=$file\"><i>Descargar CFDI</i></a><img src=\"../images/iconos/onebit_11.png\" width=\"24px\" /><br>";
                                            echo "<a href=\"cfdi_pdf.php?clave=$clave&letras=$letras\"><i>Descargar Representacion Impresa de CFDI</i></a><img src=\"../images/iconos/onebit_39.png\" width=\"24px\" /><br>";
											 echo "<a href=\"descarga_acuse.php?file=$file\"><i>Descargar Acuse de Cancelacion ante el SAT</i></a><img src=\"../images/iconos/onebit_26.png\" width=\"24px\" /><br>";
