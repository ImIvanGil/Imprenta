...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <form method="get" action="notas_credito.php" name="busqueda" id="busqueda" onSubmit="return validarBusqueda()"> 
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565">
            ...
            <h2>Lista de Notas de Cr&eacute;dito</h2>
            ...
            <tbody>
				...
				<?php 
					...
					if (isset($_GET['parametro'])) {
						  ...
						  $cons ="SELECT * FROM `nota_credito` WHERE `id_nota`= '$buscar' OR `id_cliente` in (SELECT `id_cliente` FROM `cliente` WHERE `nombre` like '%$buscar%') ORDER BY id_nota DESC;";
						  $lista_notas = $db->consulta($cons);
						  $mensaje = "Resultados de la b&uacute;squeda que contienen la palabra clave <b>$buscar</b>";
					  }else{
						  $lista_notas = $db->consulta("SELECT * FROM `nota_credito` ORDER BY id_nota DESC LIMIT 20;");
						  $mensaje = "Se muestran las ultimas 20 notas generadas, para localizar una nota en especifico, use el campo de busqueda.";
					  }
					  
					echo "<span><i>$mensaje<i></span>";
					
					
                   // $lista_notas = $db->consulta("SELECT * FROM `nota_credito` ORDER BY id_nota;");
                    while ($rowf = $db->fetch_array($lista_notas))
                        {
							$clave = $rowf['id_nota'];
							$folio = $rowf['folio'];
							...
							while ($row3 = $db->fetch_array($consulta_sta)){
							 ...
							 <td class=\"listado\"><a class=\"icono\" title=\"Ver Nota\" href=\"ficha_nota.php?numero=".$clave."\"><img src=\"../images/iconos/onebit_39.png\" width=\"24px\" align=\"center\"></a></td>";
							 if($id_status==1){
								 echo "<td class=\"listado\"><a class=\"icono\" title=\"Editar Nota\" href=\"editar_nota.php?numero=".$clave."\"><img src=\"../images/iconos/onebit_20.png\" width=\"24px\" align=\"center\"></a></td>
							 <td class=\"listado\"><a class=\"icono\" title=\"Borrar Factura\" href=JavaScript:confirma(\"http://localhost/imprenta/ventas/borrar_nota.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>
							 </tr>";
							 }else{
								 if($id_status==2){
									 echo "<td class=\"listado\">Operacion <br>No Permitida</td>
							 		<td class=\"listado\"><a class=\"icono\" title=\"Cancelar Nota\"  href=JavaScript:confirma(\"http://localhost/imprenta/ventas/cancelar_nota.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_35.png\" width=\"24px\" align=\"center\"></a></td></tr>";
								 }else{
									 echo "<td class=\"listado\">Operacion <br>No Permitida</td>
        ...
        <div class="col_260 col_last">
        	...
        	<div class="sb_news_box">
            	<ul class="tmo_list col_260">
                     <li><span>&raquo;</span><a href="lista_notas.php">Exportar a Excel</a></li>
               </ul>
            </div>
