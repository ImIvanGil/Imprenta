...
$curUser=$prot->getUser();
	  ...
	  header("Content-disposition: attachment; filename=general_ventas.xls");
...
<body>			
			...
			<tr><td align="center" colspan="13"><b>Reporte General de Ventas</b></td></tr>
				...
				while ($row = $db->fetch_array($lista_facturas))
				   ...
				   while ($row2 = $db->fetch_array($cons_abonos)){
					...
					echo "<tr><td align=\"center\">".$numero."</td>
					 ...
					 <td align=\"center\">".$plazo." d&iacute;as</td>
