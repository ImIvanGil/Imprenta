...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <a href="<?php echo "rep_fac_canceladas_excel.php?inicio=$inicio&fin=$fin";?>">Exportar a MS Excel</a>
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Reporte de Facturas Canceladas</h2>
			...
			<?php
				...
				$lista = $db->consulta("SELECT * FROM `factura` WHERE fecha BETWEEN '$ninicio' AND '$nfin' and `id_status_factura`='3'");
