...
$queFac = "SELECT * FROM `nota_credito` WHERE id_nota='".$clave."'";
...
function Header()
{
    ...
    $this->Cell(80);
    //Título
    $this->Cell(110,3,'NOTA DE CREDITO',0,0,'R');
    //Salto de línea
    $this->Ln(20);
}
...
$sql_det = "SELECT * FROM detalle_nota_credito WHERE id_nota='".$clave."'";
