							...
							<table align="center" width="550px" border="0px">
								...
								<tr align="center"><td>
                                  ...
                                  <fieldset>								  
                                    ...
                                    <tr><td align="right"><div id="motivo" style="display:none;"><span>*</span>Motivo de la nota: </div></td>
                                    <td align="left"><div id="motivo2" style="display:none;">
                                            ...
                                            <?php 
												$lista_mot = $db->consulta("SELECT * FROM `motivo_nota_credito`;");
													while ($row6 = $db->fetch_array($lista_mot))
													{
													  ...
													  $motivo = $row6['motivo'];
													  if($id_motivo==$motivo_nota){
														  	echo "<option value=\"".$id_motivo."\"selected>".$motivo."</option>";
														  }else{
