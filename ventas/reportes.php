...
if (document.reporte.tipo.value == "cliente") {
	//muestra la fecha de baja cuando el status es suspendido
	document.getElementById('div_cliente1').style.display='block';
	document.getElementById('div_cliente2').style.display='block';
	...
	if(document.reporte.tipo.value == "vendedor"){
		...
		document.getElementById('div_cliente1').style.display='none';
		document.getElementById('div_cliente2').style.display='none';
		document.getElementById('div_producto1').style.display='none';
		document.getElementById('div_producto1').style.display='none';
    ...
    <div id="templatemo_content">
        ...
        <SCRIPT LANGUAGE="JavaScript">
		  <!-- Funcion que valida que se hayan escrito los campos obligatorios-->
            ...
            <h2>Reportes de Clientes y Ventas</h2>
            <div id="data_form">
                      ...
                      <fieldset>								  
                        ...
                        <td align="left" valign="middle" colspan="3">
                        	<select id="tipo" name="tipo" onchange="mostrar();">
                                ...
                                <option value="anti">Antig&uuml;edad de cuentas por cobrar</option>
								<option value="canceladas">Facturas Canceladas</option>
                            </select>
                        </td>
                        </tr>
                        
                        <tr><td align="right"><div id="div_cliente1" style="display:none;"><span>*</span>Cliente:</div></td><td colspan="3"><div id="div_cliente2" style="display:none;"> 
