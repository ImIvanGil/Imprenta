...
$curUser=$prot->getUser();
	  ...
	  header("Content-disposition: attachment; filename=comparativo_ventas.xls");
...
<body>			
			...
			<tr><td align="center" colspan="13"><b>Reporte comparativo de ventas nacionales y en dólares</b></td></tr>
			...
			<?php 
				...
				$lista_facturas = $db->consulta("SELECT * FROM `factura` WHERE fecha BETWEEN '$ninicio' AND '$nfin' and `id_status_factura`='2'");
			...
			<tr>
				<td align=\"center\" colspan=\"6\"><img src=\"http://localhost/imprenta/ventas/graficas/ventas_ext.png\" /></td>
			</tr>
