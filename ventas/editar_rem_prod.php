...
if (isset($_GET['editar'])) {
	...
	$query = "UPDATE detalle_remision SET id_producto='$cve_prod',unitario='$unitario', cantidad='$cant', id_clase_iva='$tiva' WHERE id_detalle_rem ='$cve_det';";
	echo "la consulta es ".$query."<br>";
	$consulta = $db->consulta($query);
	$link = "Location: ficha_remision.php?numero=$cve_ped";
	header($link);
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Editar remision - Producto</h2>
            <?php
				$db = new MySQL();
				$remision = $_GET['numero'];
				$detalle = $_GET['key'];
				
				//voy a consultar los datos del registro
				$consulta_reg = $db->consulta("SELECT *  FROM `detalle_remision` WHERE `id_detalle_rem` = '".$detalle."';");
				...
				?>
				<form method="get" action="editar_rem_prod.php" name="regProd" onsubmit="return validarProd()">
                            <input type="hidden" name="numero" id="numero" value="<?php echo $remision;?>">
