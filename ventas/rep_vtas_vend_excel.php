...
$curUser=$prot->getUser();
	  ...
	  header("Content-disposition: attachment; filename=ventas_vendedor.xls");
...
<body>			
			...
			<tr><td align="center" colspan="11"><b>Reporte de Ventas por Vendedor</b></td></tr>
            <tr><td align="center" colspan="11"><?php echo "Para $vendedor de $finicio al $ffin"?></td></tr>
			</table>
			...
			<?php 
				...
				//consulto los pagos recibidos en el periodo en pesos mexicanos por los clietes del vendedor
				...
				//consulto los pagos recibidos en el en dolares por los clietes del vendedor
