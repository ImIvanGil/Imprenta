...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Nueva Nota de Cr&eacute;dito</h2>
            <div id="data_form">
			...
			<!-- Funcion que valida que se hayan escrito los campos obligatorios-->
				...
				function validar() {
					...
					if (document.registro.fecha.value == "") {
						alert ('Debe eleccionar una fecha para la nota');
					...
					if (document.registro.status.value == "-1") {
						alert ('Debe seleccionar un status para la nota');
            ...
            <form method="post" enctype="multipart/form-data" action="registro_nota.php" name="registro" onSubmit="return validar()">
                            ...
                            <!--Asigno tipo de comprobante de egresos por defecto -->
                            <input type="hidden" name="tipo_comp" id="tipo_comp" value="2">
