...
if (isset($_POST['agregar1'])) {
	...
	$consulta = $db->consulta("insert into detalle_remision(id_remision, id_producto, unitario, cantidad,id_clase_iva) values('".$cve_rem."','".$cve_prod."','".$unitario."','".$cant."','".$tiva."');");  
	$link = "Location: ficha_remision.php?numero=$cve_rem";
	header($link);
}
?>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Ficha de Datos de Remision</h2>
			...
			<?php
                ...
                $existe = $db->num_rows($remision);
                if($existe<=0){
                    echo "No hay informaci&oacute;n del remision con la clave <b>$clave</b>, verifique sus datos";
            ...
            <table align="center" border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr><td align="left">
                  ...
                  <div id="data_form">
                  <fieldset>								  
                    <legend> <B>Datos de remision</B></legend>
                    <table border="0" width="750px" align="center">	
						...
						<?php 
                            if($oc_cliente!=""){
                                echo "<tr>";
                                echo "<td align=\"right\"><b>Orden de Compra.:</b></td>";
               ...
               <?php 
				if($id_status<3){
					//si el estatus es activo podemos seguir agregando productos al remision
				?>
                    
                        <tr>
                            <td align="center">
                            <form method="post" action="ficha_remision.php" name="regProd" onsubmit="return validarProd()">
                            <input type="text" name="numero" id="numero" value="<?php echo $clave;?>">	
				 ...
				 ?>
                        ...
                        <tr>
                            <td align="left">
								<?php 
                                    $detalle = $db->consulta("SELECT * FROM `detalle_remision` WHERE id_remision='".$clave."'");
                                    $existe = $db->num_rows($detalle);
                                    if($existe<=0){
                                        echo "<p align=\"center\">No se han agregado productos al remision</p>";
											...
											?>
													...
													<?php 
                                                       ...
                                                       echo "<tr><td class=\"listado\" align=\"center\">".$i."</td>
														...
														if($id_status<3){		 
														   echo "<td class=\"listado\" align=\"center\"><a class=\"icono\" href=\"editar_rem_prod.php?numero=$clave&key=$id_detalle\"><img src=\"../images/iconos/onebit_20.png\" width=\"24px\" align=\"center\"></a></td>
																 <td class=\"listado\" align=\"center\"><a class=\"icono\" href=JavaScript:confirma(\"http://localhost/imprenta/ventas/borrar_rem_prod.php?numero=$clave&key=$id_detalle\",\"$id_detalle\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>";
								...
								//convertire el total de la remision a texto
								$importe = number_format($total_remision,2);
                                ...
                                <table border="0" width="750px" align="center">	
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">$ <?php echo number_format($total_remision,2);?></td>
                                    </tr>
                                    <tr>
                                        <td align="right" colspan="4" align="left" width="80%"><?php echo"<a href=\"remision_pdf.php?clave=$clave&letras=$letras\"><i>Descargar hoja de remision en PDF</i></a><img src=\"../images/iconos/onebit_39.png\" width=\"24px\" />"; ?></td>
                                    </tr>
                                </table>
