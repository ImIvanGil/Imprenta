    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <form method="get" action="pagos.php" name="busqueda" id="busqueda" onSubmit="return validarBusqueda()"> 
            ...
            <tbody>
				...
				<?php 
					...
					if (isset($_GET['parametro'])) {
						  ...
						  $cons ="SELECT * FROM `pago_proveedor` WHERE `id_proveedor` in (SELECT `id_proveedor` FROM `proveedor` WHERE `nombre` like '%$buscar%') OR `fecha` like '%$buscar%' OR `referencia` like '%$buscar%' AND aplicado!='3' ORDER BY id_pago DESC;";
						  $lista_pagos = $db->consulta($cons);
						  
						  $mensaje = "Resultados de la b&uacute;squeda que contienen la palabra clave <b>$buscar</b>";
					  }else{
						  $lista_pagos = $db->consulta("SELECT * FROM `pago_proveedor` where aplicado!='3' ORDER BY id_pago DESC LIMIT 20;");
                    ...
                    while ($rowf = $db->fetch_array($lista_pagos))
                        {
							$clave = $rowf['id_pago'];
							...
							if($id_tipo==6){
								...
								echo "<td class=\"listado\"><a class=\"icono\" href=\"editar_pago_proveedor.php?numero=".$clave."\"><img src=\"../images/iconos/onebit_20.png\" width=\"24px\" align=\"center\"></a></td>";
								
							}
							 
							 
						 echo "<td class=\"listado\"><a class=\"icono\" href=JavaScript:confirma2(\"http://localhost/imprenta/administracion/liberar_pago_proveedor.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_24.png\" width=\"24px\" align=\"center\"></a></td>
						 <td class=\"listado\"><a class=\"icono\" href=JavaScript:confirma(\"http://localhost/imprenta/administracion/cancelar_pago_proveedor.php?numero=$clave\",\"$clave\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>
						 </tr>";
        ...
        <div class="col_260 col_last">
        	...
        	<div class="sb_news_box">
            	<ul class="tmo_list col_260">
                     <li><span>&raquo;</span><a href="lista_pagos_proveedores.php">Exportar a Excel</a></li>
