    ...
    <div id="templatemo_content">
        ...
        <SCRIPT LANGUAGE="JavaScript">
		  <!-- Funcion que valida que se hayan escrito los campos obligatorios-->
            ...
            <form method="get" action="busqueda_empleado.php" name="buscar" onSubmit="return validar()">
                      ...
                      <fieldset>								  
                        ...
                        <tr><td align="right" valign="middle">
                        	<select id="par1" name="par1">
                                ...
                                <option value="id_empleado">Numero</option>
			   ...
			   <?php
                //+++++++++++++++++++++++++++++++SI SELECCIONO BUSCAR ++++++++++++++++++++++++++++++++++++++++
                    if (isset($_GET['buscar'])) {
						...
						if($pars!=""){
							$consulta = $consulta." WHERE ".$pars." ORDER BY id_empleado ASC;";
						}
