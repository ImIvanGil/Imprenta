								...
								<tr align="center"><td>
                                  ...
                                  <fieldset>								  
												...
												$lista_tam = $db->consulta("SELECT `id_proveedor`,`nombre` FROM `proveedor`;");
													while ($row6 = $db->fetch_array($lista_tam))
													{
													  ...
													  if($id_proveedor==$id_proveedor1){
															echo "<option value=\"".$id_proveedor1."\"selected>".$prov."</option>";
													  }else{
															 echo "<option value=\"".$id_proveedor1."\">".$prov."</option>";
													  }
                                   ...
                                   <tr>
                                    ...
                                    <td align="left" valign="middle"><input class="texto" type="text" id="plazo" name="plazo" size="10" value="<?php echo $plazo;?>"/> d&iacute;as<br />
                                   </td>
                                    </tr>
                                    
                                    <tr>
                                    <td align="right">Referencia: </td>
                                    <td align="left" valign="middle"><input class="texto" type="text" id="referencia" name="referencia" size="20" value="<?php echo $referencia;?>"/><br />
                                   </td>
                                    </tr>
                                    
                                    <tr>
                                    <td align="right"><span>*</span>Sub-Total: </td>
                                    <td align="left" valign="middle"><input class="texto" type="text" id="subtotal" name="subtotal" size="20" value="<?php echo $subtotal;?>" /><br />
                                   </td>
                                    </tr>
                                    
                                    <tr>
                                    <td align="right"><span>*</span>Impuesto: </td>
                                    <td align="left" valign="middle"><input class="texto" type="text" id="impuesto" name="impuesto" size="20" value="<?php echo $impuesto;?>"/><br />
                                   </td>
                                    </tr>
