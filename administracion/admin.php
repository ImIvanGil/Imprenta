...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
       <ul>
            ...
            <li><a href="admin.php" class="current">Administraci&oacute;n</a></li>
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565">
            ...
            <table cellspacing="0" border="0" width="100%">
                 ...
                 <tr>
                    <td width="10%"><img src="../images/iconos/onebit_47.png" alt="image 3" width="35px" /></td>
                    <td><a href="cargos.php">Cargos</a></td>
                    <td>&nbsp;</td>
                 ...
                 <tr>
                    ...
                    <td><a href="pagos.php">Pagos</a></td>
                    <td>&nbsp;</td>
                    <td width="10%">&nbsp;</td>
                    <td>&nbsp;</td>
                 ...
                 <!--tr>
                    <td width="10%"><img src="../images/iconos/onebit_18.png" alt="image 3" width="35px" /></td>
