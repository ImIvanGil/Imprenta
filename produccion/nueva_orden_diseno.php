...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Nueva Orden de Dise&ntilde;o</h2>
            <div id="data_form">
            ...
            <form method="POST" action="registro_orden_diseno.php" enctype="multipart/form-data"  onSubmit="return validar()" name="registro" id="registro">
               ...
               <tr><td align="right">Fecha orden:</td>
                <td> <?php echo date('Y-m-d');?> <input type="hidden" id="fecha" name="fecha" value="<?php echo date('Y-m-d');?>"/></td>
               </tr>
              ...
              <td align="right"><span>*</span>Producto: </td>
                ...
                <td align="left"><textarea class="textarea" name="especificaciones" id="especificaciones" cols="0" rows="0"></textarea></td></tr>
                <tr><td colspan="2" align="center"><span>Una vez registrada la orden, podra adjuntar archivos.</span></td></tr>
                <tr>
