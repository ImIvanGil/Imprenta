    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <form method="get" action="productos.php" name="busqueda" id="busqueda" onSubmit="return validarBusqueda()"> 
        ...
        <div class="col_260 col_last">
        	...
        	<div class="sb_news_box">
            	<ul class="tmo_list col_260">
                     <li><span>&raquo;</span><a href="lista_productos.php">Exportar a Excel</a></li>
               </ul>
            </div>
