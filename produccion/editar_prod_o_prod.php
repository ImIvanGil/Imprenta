...
if (isset($_GET['editar'])) {
	...
	$query = "UPDATE detalle_orden_produccion SET id_producto='$cve_prod',cantidad='$cant' WHERE id_detalle ='$cve_det';";
	echo "la consulta es ".$query."<br>";
	$consulta = $db->consulta($query);
	$link = "Location: ficha_orden_prod.php?numero=$cve_ord";
	header($link);
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	...
    	<div class="col_w565_interior">
            ...
            <h2>Editar Orden de Producci&oacute;n - Producto</h2>
            <?php
				$db = new MySQL();
				$orden = $_GET['orden'];
				$numero = $_GET['numero'];
				...
				$consulta_reg = $db->consulta("SELECT *  FROM `detalle_orden_produccion` WHERE `id_detalle` = '".$numero."';");
				...
				?>
				<form method="get" action="editar_prod_o_prod.php" name="regProd" onsubmit="return validarProd()">
                            <input type="hidden" name="numero" id="numero" value="<?php echo $orden;?>">
                            <input type="hidden" name="key" id="key" value="<?php echo $numero;?>">	
                            	<table border="0" width="700px">	
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td align="center"><input class="submit_btn reset" type="submit" name="editar" id="editar" value="Actualizar"/></td>
                                    </tr>
                                </table>
                            </form>
