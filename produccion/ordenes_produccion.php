    ...
    <div id="templatemo_service_bar">
    	...
    	<div class="sb_box sb_box_last">
         ...
         <div class="sb_box">
            ...
            <form method="get" action="ordenes_produccion.php" name="busqueda" id="busqueda" onSubmit="return validarBusqueda()"> 
            ...
            <tbody>
				...
				<?php 
					...
					if (isset($_GET['parametro'])) {
						  ...
						  $cons ="SELECT * FROM `orden_produccion` WHERE `id_orden`= '$buscar' OR `fecha`= '$buscar' ORDER BY id_orden DESC;";
						  $lista_orden = $db->consulta($cons);
						  
						  $mensaje = "Resultados de la b&uacute;squeda que contienen la palabra clave <b>$buscar</b>";
					  }else{
						  $lista_orden = $db->consulta("SELECT * FROM `orden_produccion` ORDER BY id_orden DESC LIMIT 20;");
                    ...
                    while ($row = $db->fetch_array($lista_orden))
                        {
							...
							echo "<tr><td class=\"listado\" align=\"center\">".$numero."</td>
							 ...
							 <td class=\"listado\">".$nom_cliente."</td>
							 <td class=\"listado\" align=\"center\"><a class=\"icono\" title=\"Ver Orden\" href=\"ficha_orden_prod.php?numero=".$numero."\"><img src=\"../images/iconos/onebit_39.png\" width=\"24px\" align=\"center\"></a></td>";
							 if($id_estado<2){
								  echo "<td class=\"listado\" align=\"center\"><a class=\"icono\" title=\"Editar Orden\" href=\"editar_orden_produccion.php?numero=".$numero."\"><img src=\"../images/iconos/onebit_20.png\" width=\"24px\" align=\"center\"></a></td>
							 <td class=\"listado\" align=\"center\"><a class=\"icono\" title=\"Borrar Orden\" href=JavaScript:confirma(\"http://localhost/imprenta/produccion/borrar_orden_prod.php?numero=$numero\",\"$numero\");><img src=\"../images/iconos/onebit_33.png\" width=\"24px\" align=\"center\"></a></td>";
								 
							 }else{
								  echo "<td class=\"listado\" align=\"center\">Operacion No Permitida</td>
							 <td class=\"listado\" align=\"center\">Operacion No Permitida</td>";
							 }
        ...
        <div class="col_260 col_last">
        	...
        	<div class="sb_news_box">
            	<ul class="tmo_list col_260">
                     <li><span>&raquo;</span><a href="lista_ordenes_produccion.php">Exportar a Excel</a></li>
               </ul>
