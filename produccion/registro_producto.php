    	...
    	<div class="col_w565_interior">
            ...
            <h2>Registro de Producto</h2>
             ...
             <?php 
				...
				$repeticionese = $_POST['repeticionese'];
				$repeticionesd = $_POST['repeticionesd'];
				$corea = $_POST['corea'];
				$cored = $_POST['cored'];
				...
				if ($operacion =="registrar"){
					...
					if($db->num_rows($consulta_verifica)>0){
						...
						$consulta = $db->consulta("insert into producto(clave, nombre, id_tintas, descripcion, precio,id_linea, id_status_prod, id_unidad, id_cliente, id_tipo_papel, laminado, barnizado, etiquetadora, prensa,rebobinado, color, dado, largo, ancho, precorte, ext_largo, ext_ancho, grapado, pegado, marginal, prefijo, sufijo, perforacion, engargolado, encuadernado, impresion, cant, core_diam, core_ancho, dientes, repeticiones_eje, repeticiones_des) values('".$cve."','".$nombre."','".$tinta."','".$descripcion."','".$precio."','".$linea."','".$status."','".$unidad."','".$cliente."','".$papel."','".$laminado."','".$barnizado."','".$etiquetadora."','".$prensa."','".$rebobinado."','".$color."','".$dado."','".$largo."','".$ancho."','".$precorte."','".$ext_largo."','".$ext_largo."','".$grapado."','".$pegado."','".$marginal."','".$prefijo."','".$sufijo."','".$perforacion."','".$engargolado."','".$encuadernado."','".$impresion."','".$cant."','".$cored."','".$corea."','".$dientes."','".$repeticionese."','".$repeticionesd."');");   
					...
					$query = "UPDATE producto SET clave='$cve', nombre='$nombre', id_tintas='$tinta', descripcion='$descripcion', precio='$precio', id_linea='$linea', id_status_prod='$status', id_unidad='$unidad', id_cliente='$cliente', id_tipo_papel='$papel', laminado='$laminado', barnizado='$barnizado', etiquetadora='$etiquetadora', prensa='$prensa', rebobinado='$rebobinado', color='$color', dado='$dado', largo='$largo', ancho='$ancho', precorte='$precorte', ext_largo='$ext_largo', ext_ancho='$ext_ancho', grapado='$grapado', pegado='$pegado', marginal='$marginal', prefijo='$prefijo', sufijo='$sufijo', perforacion='$perforacion', engargolado='$engargolado', encuadernado='$encuadernado', impresion='$impresion', cant='$cant', core_ancho='$corea',core_diam='$cored', dientes='$dientes', repeticiones_eje='$repeticionese', repeticiones_des='$repeticionesd'  WHERE id_producto ='$numero_original';";
