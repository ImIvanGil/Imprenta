    	...
    	<div class="col_w565_interior">
			...
			<?php
                ...
                while ($row = $db->fetch_array($producto))
                {
					...
					while ($row2 = $db->fetch_array($consulta_pap)){$papel = $row2['nombre'];}
                ...
                <tr><td align="center">
                  ...
                  <fieldset><legend><b>Detalle de Copias</b></legend>
                        ...
                        <select id="papel" name="papel">
                            ...
                            <?php 
                                $lista_pap = $db->consulta("SELECT * FROM `insumo` where `id_clase` = '4';");
                                    while ($row7 = $db->fetch_array($lista_pap))
                                    {
                                      $id_tipo_pap = $row7['id_insumo'];
                                      $nombre = $row7['nombre'];
                                      echo "<option value=\"".$id_tipo_pap."\">".$nombre."</option>";
                                    }
                            ?>
                        </select>
                        </td>
